...
public class BusqFragment extends Fragment implements OnMapReadyCallback, LocationListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        miView = inflater.inflate(R.layout.fragment_busq, null);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mapView = miView.findViewById(R.id.map);
